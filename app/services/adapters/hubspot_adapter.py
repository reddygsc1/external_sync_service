...
class HubSpotAdapter(BaseAdapter):
    """HubSpot adapter for contact data transformation using Pydantic models"""
    ...
    def transform_to_external(self, internal_data: Union[InternalContact, Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            hubspot_properties = HubSpotContactProperties(
                ...
                lifecyclestage=self._map_contact_type_to_lifecycle_stage(internal_contact.contact),
                hs_lead_status=self._map_contact_type_to_lead_status(internal_contact.contact),
                company=internal_contact.company or self.extract_company_from_email(internal_contact.email),
                jobtitle=internal_contact.title or self._map_contact_type_to_job_title(internal_contact.contact),
                department=internal_contact.department or self._map_contact_type_to_department(internal_contact.contact),
                ...
                relationship_type=self._map_contact_type_to_relationship_type(internal_contact.contact),
    ...
    def transform_from_external(self, external_data: Dict[str, Any]) -> InternalContact:
        ...
        try:
            ...
            internal_contact = InternalContact(
                ...
                contact=self._map_hubspot_stage_to_contact_type(properties.lifecyclestage, properties.hs_lead_status),
    ...
    def _map_hubspot_stage_to_contact_type(self, lifecycle_stage: str, lead_status: str) -> str:
