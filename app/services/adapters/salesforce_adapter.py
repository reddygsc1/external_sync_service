...
class SalesforceAdapter(BaseAdapter):
    ...
    def transform_to_external(self, internal_data: Union[InternalContact, Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            salesforce_contact = SalesforceContact(
                ...
                LeadSource=self._map_contact_type_to_lead_source(internal_contact.contact),
                ...
                Title=internal_contact.title or self._map_contact_type_to_title(internal_contact.contact),
    ...
    def transform_from_external(self, external_data: Dict[str, Any]) -> InternalContact:
        ...
        try:
            ...
            internal_contact = InternalContact(
                ...
                contact=self._map_salesforce_type_to_contact_type(salesforce_contact.Type, salesforce_contact.LeadSource),
    ...
    def _map_salesforce_type_to_contact_type(self, sf_type: str, lead_source: str) -> str:
